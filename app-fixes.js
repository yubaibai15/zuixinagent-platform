...
(() => {
  ...
  welcomeHeroStyle.textContent = `#agent-chat .chat-welcome h1{margin:8px 0 12px!important;font-size:clamp(38px,3.2vw,52px)!important;line-height:1.16!important;letter-spacing:-.04em!important}#agent-chat .chat-welcome img{display:block;width:246px!important;height:246px!important;margin:20px auto 18px!important;border-radius:42px!important;background:#fffdf8!important;box-shadow:0 10px 30px rgba(49,42,20,.06)!important}@media(max-width:700px){#agent-chat .chat-welcome img{width:180px!important;height:180px!important}#agent-chat .chat-welcome h1{font-size:32px!important}}`;
